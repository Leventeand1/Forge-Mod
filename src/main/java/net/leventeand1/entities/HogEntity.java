package net.leventeand1.entities;
...
public class HogEntity extends AnimalEntity {
    ...
    public static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(Items.CARROT, Items.POTATO, Items.BEETROOT, ModItems.RUBY.get());
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        return MobEntity.func_233666_p_()
                .createMutableAttribute(Attributes.MAX_HEALTH, 15.00)
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playStepSound(pos, blockIn);
    }
